# BannerlordCoopCampaign v0.3.2 — Installation Guide

## Client Installation

1. Right-click the archive `BannerlordCoopCampaign_v0.3.2_Client.zip`.
2. Open **Properties**.
...
1. Right-click the archive `BannerlordCoopCampaign_v0.3.2_Host.zip`.
2. Open **Properties**.
3. Check if there is a Security message at the bottom saying: "This file came from another computer and might be blocked to help protect this computer."
4. If the message exists, click **Unblock**.
5. Click **Apply**.
...
Joining a campaign battle that is already in progress is not yet supported.
