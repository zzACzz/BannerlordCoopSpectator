...
- `Infrastructure/Automation/CoopAutomationJoinContract.cs`: schema 3, request validation, SHA-256 binding, exact server selection, and terminal-state rules.
