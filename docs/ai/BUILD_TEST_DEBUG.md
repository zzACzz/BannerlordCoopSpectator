...
Last automation-control source verification: **2026-09-02** (`m2b3a-lockfix-c-01`; exact per-resource shared-lock construction/collision contracts passed in both PowerShell hosts; dirty-source 22/22)
Last automation-control live verification: **2026-09-02** (`m2b3a-live-r1-01`; exact new client/dedicated loaded identities, live schema-2 role health, formal `Connected`, graceful exact cleanup, free ports, protected-state preservation, and no crash/hang artifact confirmed; RUN-008 remains open because the pre-correction artifact contained one concatenated lock)
...
Current on-disk boundary: controlled transaction `m2b3a-stage-01` installed the exact clean-published Revision 17 client DLL `A363B19BFFBDA8EEDEE99EEB90E12DA0BFD508C2EA67DE70A5ACAC9DC91C0075`, client PDB `E031D36E6F3F114A171EDDE12E6DFA2B7E14BCCFBC98BD57B9BC737640595DEF`, and dedicated DLL `2E1494BCAEE1DCE440B4373BBA99A4F724B9C32519AACD486DE8F041C0CA1414` in both dedicated bins. The complete preceding 32-file client and 218-file dedicated trees remain under the run-owned backup root. Run `m2b3a-live-r1-01` promoted both installed DLL identities to `ConfirmedLoadedHash`. The newer Revision 18 shared-lock fix changes only runner scripts and contracts, so no restaging is required before its repeat live verification. Earlier staging and backup chains remain retained as historical evidence.
