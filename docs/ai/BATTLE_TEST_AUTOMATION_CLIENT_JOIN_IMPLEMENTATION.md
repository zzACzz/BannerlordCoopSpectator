...
Before a real connectivity-only rerun:

1. commit and stage the compile-only-verified Milestone 2B.1 runtime-safety source as one identifiable client/dedicated binary pair;
