...
Current field automation stage: **Milestone 3 complete; Milestone 4 remains open. The recovered `m4sd-p1-l1` attempt loaded the scoreboard-corrected dedicated DLL, but finalization did not complete and L2 did not pass. This revision records the Windows PowerShell 5.1 event-string serialization correction and its focused tests; 16 cases passed across PowerShell 5.1 and 7 on 2026-09-10.** See [implementation, focused evidence and remaining native gate](BATTLE_TEST_AUTOMATION_M4_FIELD_SPAWN_SMOKE.md#21-event-tail-serialization-correction-and-focused-contracts-2026-09-10). The full suite, module builds and post-correction native run were not performed. This supersedes older next-action statements without adding a runtime pass.
