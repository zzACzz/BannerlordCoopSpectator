...
Current field automation stage: **Milestone 3 complete; Milestone 4 readiness and shared failure handling corrected and L1-verified after the first live attempt failed before mission. A fresh native L2 rerun remains pending.** See [BATTLE_TEST_AUTOMATION_M4_FIELD_SPAWN_SMOKE.md](BATTLE_TEST_AUTOMATION_M4_FIELD_SPAWN_SMOKE.md) for profile, source map, validation artifacts and the same-process reset gap.

Latest field live attempt: **2026-09-09**, m4b-local-live-20260909-01 from clean ebf9cd3: exact dedicated hash and seven bootstrap acknowledgements confirmed; parent Timeout, incorrect readiness interface name and stalled failure handling found. Manual exact cleanup completed; original 218-file dedicated and 32-file client inventories verified, ports/locks clear. Second attempt Not Run; no L2 pass. Fresh contracts passed 24/24 and both builds passed. [Evidence, restoration and remaining work](BATTLE_TEST_AUTOMATION_M4_FIELD_SPAWN_SMOKE.md#12-first-clean-local-only-live-attempt-2026-09-09).
