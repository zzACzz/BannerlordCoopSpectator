...
Revision: **28 — Clean M4 rerun reached the corrected binary but cancelled at the parent/child liveness gate; automatic cleanup and full restoration passed, native L2 pending**
