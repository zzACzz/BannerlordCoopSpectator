...
Revision: **32 — The correlated full dump identifies a managed MissionScoreboardComponent dependency failure; an unchanged native rerun was cancelled and the cross-mode source fix is pending**
