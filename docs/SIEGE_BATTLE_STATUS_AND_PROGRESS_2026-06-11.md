...
## Актуальний зріз на 2026-06-21

Останній підтверджений добрий стан: нові формації в commander deployment menu (командирському меню розстановки) створюються, наповнюються повзунками і реально переміщують своїх бійців.

Останній контрольний commit (фіксація змін):

- `655a074 Fix siege deployment formation sync`.
...
- Composition payload (пакет складу формацій) передає бажані кількості піхоти і стрільців по кожному слоту формації, а не нестабільні client-side agent indexes (клієнтські індекси агентів).
- Server-authoritative sync (серверне остаточне застосування синхронізації) на сервері сам розкладає реальних агентів по формаціях згідно з бажаними кількостями.
...
- Візуальні проблеми з чорними ділянками сцени або відсутніми об'єктами не є частиною логіки меню розстановки і потребують окремої scene/material pass (перевірки сцени та матеріалів).
