...
## Актуальний зріз на 2026-06-22

Останній підтверджений добрий стан: commander deployment menu (командирське меню розстановки) для облоги вже підтримує створення формацій, повзунки, миттєве переміщення формацій, нижнє меню наказів F1-F9 і кнопки пріоритезації бійців. Після зміни пріоритезації бійці одразу переставляються на актуальні місця без додаткового руху формації.
