...
3. Прибрати listed-shell native agent-visual/equipment bootstrap legacy (`CreateAgentVisuals`, `MissionLobbyEquipmentNetworkComponent`) після перевірки late-join/reconnect contract без нього.
