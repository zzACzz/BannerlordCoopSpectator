...
| Етап 3.3 (spectator / unit selection / spawn) | 🔄 В роботі | Технічний план: ETAP_3_3_TECHNICAL_PLAN.md. Додано логування (mission entered, has agent, is spectator, team, controlled agent changed, returned to spectator). CoopMissionClientLogic/CoopMissionSpawnLogic інжектуються в TdmClone і CoopBattle. Для поточного listed flow (ваніль TDM на дедику) — або перейти на TdmClone на дедику, або додати Harmony-патч для інжекції. |
| Етап 3.4–3.5 (спавн гравців, повернення spectator) | ⏳ Далі по плану | Після підтвердження стану клієнта в місії (логи) |
