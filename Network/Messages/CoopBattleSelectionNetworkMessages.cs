...
namespace CoopSpectator.Network.Messages
{
    ...
    [DefineGameNetworkMessageTypeForMod(GameNetworkMessageSendType.FromClient)]
    public sealed class CoopInitialAgentMaterializationReadyMessage : GameNetworkMessage
    {
        ...
        public CoopInitialAgentMaterializationReadyMessage(
            int transmissionId,
            int entryCount,
            int readyAgentCount,
            string payloadHash)
        ...
        protected override string OnGetLogFormat()
        {
            return "CoopInitialAgentMaterializationReady TransmissionId=" + TransmissionId +
                " EntryCount=" + EntryCount +
                " ReadyAgentCount=" + ReadyAgentCount;
        }
    }
    ...
    [DefineGameNetworkMessageTypeForMod(GameNetworkMessageSendType.FromClient)]
    public sealed class CoopInitialFieldBattleMaterializationReadyMessage : GameNetworkMessage
    {
        private static readonly CompressionInfo.Integer TransmissionCompressionInfo =
            new CompressionInfo.Integer(0, 1048575, maximumValueGiven: true);
        private static readonly CompressionInfo.Integer CountCompressionInfo =
        ...
        public CoopInitialFieldBattleMaterializationReadyMessage(
            int transmissionId,
            int entryCount,
            int readyAgentCount,
            string payloadHash)
        ...
        protected override string OnGetLogFormat()
        {
            return "CoopInitialFieldBattleMaterializationReady TransmissionId=" + TransmissionId +
                " EntryCount=" + EntryCount +
                " ReadyAgentCount=" + ReadyAgentCount;
        }
    }
    ...
    [DefineGameNetworkMessageTypeForMod(GameNetworkMessageSendType.FromClient)]
    public sealed class CoopInitialSiegeAssaultMaterializationReadyMessage : GameNetworkMessage
    {
        private static readonly CompressionInfo.Integer TransmissionCompressionInfo =
            new CompressionInfo.Integer(0, 1048575, maximumValueGiven: true);
        private static readonly CompressionInfo.Integer CountCompressionInfo =
        ...
        public CoopInitialSiegeAssaultMaterializationReadyMessage(
            int transmissionId,
            int entryCount,
            int readyAgentCount,
            string payloadHash)
        ...
        protected override string OnGetLogFormat()
        {
            return "CoopInitialSiegeAssaultMaterializationReady TransmissionId=" + TransmissionId +
                " EntryCount=" + EntryCount +
                " ReadyAgentCount=" + ReadyAgentCount;
        }
    }
    ...
    [DefineGameNetworkMessageTypeForMod(GameNetworkMessageSendType.FromClient)]
    public sealed class CoopInitialSiegeAmbushMaterializationReadyMessage : GameNetworkMessage
    {
        private static readonly CompressionInfo.Integer TransmissionCompressionInfo =
            new CompressionInfo.Integer(0, 1048575, maximumValueGiven: true);
        private static readonly CompressionInfo.Integer CountCompressionInfo =
        ...
        public CoopInitialSiegeAmbushMaterializationReadyMessage(
            int transmissionId,
            int entryCount,
            int readyAgentCount,
            string payloadHash)
        ...
        protected override string OnGetLogFormat()
        {
            return "CoopInitialSiegeAmbushMaterializationReady TransmissionId=" + TransmissionId +
                " EntryCount=" + EntryCount +
                " ReadyAgentCount=" + ReadyAgentCount;
        }
    }
