            ...
            try
            {
                ...
                if (EnableManualHarmonyApply)
                {
                    if (EnableManualPatchLobbyClient)
                    {
                        ...
                        ListedShellLobbyGameStateOwnershipPatch.Apply(harmony);
                        ...
                        if (EnableManualPatchMissionFlowBattleRuntime)
                        {
                            ...
                            if (EnableManualPatchMissionFlowBattleRuntimeBootstrapGates)
                            {
                                ...
                                if (EnableManualPatchMissionFlowBattleRuntimeFinishedLoadingGate)
                                {
                                    ...
                                    ListedShellInitializeCustomGameOwnershipPatch.Apply(harmony);
                                    ListedShellInitializeCustomGameReceiveOwnershipPatch.Apply(harmony);
                                    ListedShellLoadMissionReceiveOwnershipPatch.Apply(harmony);
                                    ListedShellUnloadMissionReceiveOwnershipPatch.Apply(harmony);
                                }
                                else
                                {
